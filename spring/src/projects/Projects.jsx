...
const Projects = () => {
  ...
  const findSpringProject = state.springProjects.filter((el) => search.test(el.title));
  const findSpringAtticProject = state.springAtticProjects.filter((el) => search.test(el.title));
  const createSpringProject = findSpringProject.length
    ? findSpringProject.map((el) => (
      <SpringProject
        key={el.title}
        img={el.img}
        title={el.title}
